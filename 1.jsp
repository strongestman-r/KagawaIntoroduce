...
<% 
	...
	PreparedStatement stmt = conn.prepareStatement(
			"SELECT * FROM tourist WHERE Spot_No='1'");
...
%>
<p><img src="1.jpg" width="100%" height="100%"></p>
<input id="address" type="text" value="香川県坂出市番の州緑町" size="50" />
<button id="button">地図を表示</button>
